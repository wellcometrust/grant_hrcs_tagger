...
class DictionaryArray:
    ...
    Each dictionary key has an associated set containing multiple unique
    values.
    ...
    def __init__(self, n_arrays):
        ...
        if n_arrays < 1:
            raise ValueError(
                'Number of arrays must be an integer of 1 or greater'
            )
    ...
    def remove_key(self, array_id, key):
        ...
        Deletes key from specified dictionary including the associated set of
        values.
